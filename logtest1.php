<?php 
 if(isset($_GET['msg1'])){
  echo '<script language="javascript">';
    echo 'alert("Test Code is Incorrect!")';
    echo '</script>';
}
  ?>
<?php 
...
<form method="post" action="logtest.php">
   ...
   <br><br>
   <label for="uname"><b>Test Code</b></label><br>
   <input type="text" placeholder="Enter Code" name="code" required><br>
    <label for="uname"><b>Username</b></label><br>
   <input type="text" placeholder="Enter Username" name="email" required><br>
    <label for="psw"><b>Password</b></label><br>
    <input type="password" placeholder="Enter Password" name="psw" required><br>
    <button type="submit">Start Test</button><br>
</form></div>
</th>
</table>
</div>
